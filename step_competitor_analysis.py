...
Output EXACTLY these 4 sections, in this order, and nothing else: \
Competitive Landscape, SWOT Analysis, Strategic White Spaces, Key Strategic \
Opportunities. Do not add an executive summary, introduction, overview, \
methodology note, or conclusion/closing remarks \u2014 nothing before the \
first section heading and nothing after the last section's content.
...
##  Strategic White Spaces - Identify underserved or emerging opportunities in the market. Give me at least 5 strategic white spaces.
...
# The only 4 sections the model is allowed to produce \u2014 used to split the
